<template>
    <container-app type="fixed">
        <div class="flex justify-between items-center gap-3 sm:gap-app">
            ...
            <el-button :disabled="!$hasPermission('teams.create')" @click="createDialogRef?.open()" class="w-8 sm:w-auto m-0!" type="success">
        ...
        <div class="flex-1 min-h-0 min-w-0">
            <data-grid-app
                ...
                @row-click="$router.push({ name: 'teams-detail', params: { uid: $event.data.uid } })"
            />
        </div>
